    ...
    return (
        <div className="max-w-md mx-auto mt-20 bg-white p-8 rounded-xl shadow-lg border border-gray-100">
            <div className="text-center mb-8">
                ...
                <p className="text-gray-500">Sign in to your Swa-desh account</p>
            </div>
                    ...
                    <>
                        ...
                        <div>
                            <div className="flex justify-between mb-2">
                                ...
                                <Link href="/forgot-password" title="Click to reset password" id="forgot-password-link" className="text-sm font-semibold text-gray-900 hover:underline">Forgot password?</Link>
                            </div>
                            <input
                                type="password"
                                required
